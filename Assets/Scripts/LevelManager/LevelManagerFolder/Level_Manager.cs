...
public class Level_Manager : MonoBehaviour
{
    ...
    //Lists for Spawnables
    [SerializeField] private List<GameObject> tank_ai_possibilities;
    [SerializeField] private List<GameObject> obstacles_possibilities;
    [SerializeField] private List<GameObject> interactables_possibilities;
    [SerializeField] private int spawnable_objects = 0;
    [SerializeField] private LevelDifficulty level_difficulty = LevelDifficulty.Easy;
    ...
    public void LevelSettings()
    {
        switch (level_difficulty)
        {
            case LevelDifficulty.Easy:
                {
                    //spawnable_objects = x_scale * z_scale
                    break;
                }
    ...
    {      
       ...
       // ground.GetComponent<MeshGenerator>().SetGridSize((int)x_scale, (int)z_scale);
